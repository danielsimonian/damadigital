...
<body class="bg-secondary">
  ...
  <main class="container">
    <div class="card text-bg-light mt-5 w-50 h-auto m-auto">
      <div class="card-header text-bg-secondary text-light">
        Login
      </div>
      <div class="card-body text-bg-light">
        <form class="row justify-content-center" action="valida_login.php" method="POST">
          ...
          <div class="text-end mb-2 col-11">
            <a class="text-primary link-offset-2 link-underline link-underline-opacity-0" href="cadastro.php">
              Novo? Cadastre-se
            </a>
          </div>
